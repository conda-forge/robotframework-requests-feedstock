...
Once the `conda-forge` channel has been enabled, `robotframework-requests` can be installed with:

```
conda install robotframework-requests
```

It is possible to list all of the versions of `robotframework-requests` available on your platform with:
